      ...
      <div className='container px-8 py-8 mx-auto sm:px-6 '>
        ...
        <div className='grid gap-4 md:grid-cols-2 md:gap-8 xl:gap-20 md:items-center'>
          <div>
            ...
            <div className='grid grid-cols-2 mt-6 lg:mt-10 gap-x-5'>
              ...
              <div className='py-5'>
                ...
                <p className='mt-3 text-sm text-gray-800 dark:text-gray-200'>
                  <span className='font-bold'>4.8</span> /5 - from 5k offline
                  reviews
                </p>
              </div>
            </div>
          ...
          <div className='relative ml-4'>
            <img
              src='https://images.pexels.com/photos/4050334/pexels-photo-4050334.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'
              alt=''
